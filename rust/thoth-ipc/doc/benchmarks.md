# thoth_ipc Rust Port Performance Benchmarks

The `thoth_ipc` Rust port includes a direct translation of the C++ benchmark suite (`bench_ipc`). This allows for a direct comparison between the original C++ implementation and the new pure Rust implementation.
