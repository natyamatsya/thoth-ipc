...
same structure and phasing used for the Rust port (`rust/thoth-ipc/`).
...
swift/thoth-ipc/
  ...
  Tests/
    ThothIPCTests/     ← mirrors tests/ in rust/thoth-ipc
  Sources/
...
All demos are Swift executables in `swift/thoth-ipc/Sources/` using Swift
