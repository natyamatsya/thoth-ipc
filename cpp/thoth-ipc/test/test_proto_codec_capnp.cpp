...
#include "thoth-ipc/proto/typed_channel_capnp.h"
#include "thoth-ipc/proto/typed_route_capnp.h"
...
static_assert(thoth::proto::capnp_wire_message<fake_capnp_message>);
static_assert(thoth::proto::proto_codec<thoth::proto::capnp_codec, fake_capnp_message>);

using capnp_channel = thoth::proto::typed_channel_capnp<fake_capnp_message>;
using capnp_route = thoth::proto::typed_route_capnp<fake_capnp_message>;
...
TEST(CapnpCodec, BuilderFromMessageSerializesBytes) {
    ...
    auto builder = thoth::proto::capnp_builder::from_message(msg);
...
TEST(CapnpCodec, DecodeReturnsTypedMessage) {
    ...
    auto decoded = thoth::proto::capnp_codec::decode<fake_capnp_message>(std::move(buf));
...
TEST(CapnpCodec, TypedRouteRoundTrip) {
    ...
    thoth::proto::typed_route_capnp<fake_capnp_message>::clear_storage(name.c_str());

    thoth::proto::typed_route_capnp<fake_capnp_message> sender{name.c_str(), thoth::sender};
    thoth::proto::typed_route_capnp<fake_capnp_message> receiver{name.c_str(), thoth::receiver};
    ...
    const auto builder = thoth::proto::capnp_builder::from_message(msg);
...
TEST(CapnpCodec, TypedChannelRoundTrip) {
    ...
    thoth::proto::typed_channel_capnp<fake_capnp_message>::clear_storage(name.c_str());

    thoth::proto::typed_channel_capnp<fake_capnp_message> sender{name.c_str(), thoth::sender};
    thoth::proto::typed_channel_capnp<fake_capnp_message> receiver{name.c_str(), thoth::receiver};
